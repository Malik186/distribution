...
document.addEventListener("DOMContentLoaded", function () {
    ...
    data: {
        ...
        datasets: [
            {
                label: "Completed",
                backgroundColor: "rgba(134, 77, 217, 0.57)",
                hoverBackgroundColor: "rgba(134, 77, 217, 0.8)",
                borderColor: "rgba(134, 77, 217, 1)",
                borderWidth: 1,
            ...
            },
            {
                ...
                hoverBackgroundColor: "rgba(75, 75, 75, 0.8)",
                borderColor: "rgba(75, 75, 75, 1)",
                borderWidth: 1,
                data: [35, 40, 20, 19, 44, 45, 60],
            },
        ],
    },
});
    ...
    // Bar Chart
    // ------------------------------------------------------ //
    const BARCHARTEXMPLE2 = document.getElementById("barChartExample2");
    var barChartExample = new Chart(BARCHARTEXMPLE1, {
        type: "bar",
        options: {
            scales: {
